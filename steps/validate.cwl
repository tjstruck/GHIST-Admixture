    ...
    - entryname: validate.py
      entry: |
        ...
        if args.submission_file is None:
            ...
            if invalid_reasons == []:
                try:
                    fi['parameters']['Modern_pop1_proportion_admixture']
                    fi['parameters']['Modern_pop1_generations_since_admixture']
                    fi['parameters']['Modern_pop2_proportion_admixture']
                    fi['parameters']['Modern_pop2_generations_since_admixture']
                except KeyError:
